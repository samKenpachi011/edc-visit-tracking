# -*- coding: utf-8 -*-
#
# bhp_visit_tracking documentation build configuration file, created by
...
htmlhelp_basename = 'bhp_visit_trackingdoc'
...
latex_documents = [
  ('index', 'bhp_visit_tracking.tex', u'bhp\\_visit\\_tracking Documentation',
...
man_pages = [
    ('index', 'bhp_visit_tracking', u'bhp_visit_tracking Documentation',
...
texinfo_documents = [
  ('index', 'bhp_visit_tracking', u'bhp_visit_tracking Documentation',
   u'erik van widenfelt', 'bhp_visit_tracking', 'One line description of project.',
   'Miscellaneous'),
]
